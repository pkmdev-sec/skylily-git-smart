...
const SCOPE_PATTERNS: Array<{ pattern: RegExp; scope: string }> = [
...
const TYPE_PATTERNS: Array<{ pattern: RegExp; type: string; weight: number }> = [
  // Docs
...
const DIFF_PATTERNS: Array<{ pattern: RegExp; type: string; weight: number }> = [
  // Fix indicators
 ...
 */
function detectType(files: string[], diff: string): { type: string; confidence: number } {
 ...
 */
function generateSubject(files: string[], diff: string, type: string): string {
